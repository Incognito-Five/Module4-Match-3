...
function GameOverState:render()
    ...
    love.graphics.setColor(60/255, 179/255, 113/255, 234/255)
    love.graphics.rectangle('fill', VIRTUAL_WIDTH / 2 - 64, 64, 128, 136, 4)
    
    love.graphics.setColor(0/255, 0/255, 0, 1)
    
    love.graphics.printf('GAME OVER', VIRTUAL_WIDTH / 2 - 64, 64, 128, 'center')
    
    love.graphics.setFont(gFonts['medium'])
    love.graphics.printf('SCORE: ' .. tostring(self.totalScore), VIRTUAL_WIDTH / 2 - 64, 140, 128, 'center')
